...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if launchedBefore  {
            ...
            storyboardID = "PhotosCollectionController"
            storyboardID = "launchView"
        } else {
            UserDefaults.standard.set(true, forKey: "launchedBefore")
            KeychainWrapper.standard.removeObject(forKey: "userPassword")   //Should clear any previous entried if app has been deleted
            storyboardID = "SettingsView"
            storyboardID = "launchView"
        }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let container = NSPersistentContainer(name: "Photoshare")
